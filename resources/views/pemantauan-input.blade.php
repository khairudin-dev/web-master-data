                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Input Pemantauan Lapangan 3</h5>
                                </div>
                                <div class="card-body">
                                    <form id="form_regis"
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <label for="alamat">Keterangan Hasil Pemantauan</label>
                                            <input type="text"
                                                class="form-control @error('alamat') is-invalid @enderror"
                                                value="{{ old('alamat', isset($edit) && $edit ? $lahan->alamat_parts[0] : '') }}"
                                                id="alamat" name="alamat"
                                                placeholder="Keterangan hasil pemantauan...">
                                            @error('alamat')
                                                <div class="jquery-validation-error small form-text invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-row">
                                            <!-- Kolom Kiri -->
                                            <div class="col-md-6">
                                                <label for="lokasi">Bukti Pemantauan</label>
                                                <div class="text-center mb-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="datetimepicker-semai"
                                                        data-target-input="nearest">
                                                        <input type="text"
                                                            ...
                                                            data-toggle="datetimepicker"
                                                            data-target="#datetimepicker-semai" id="semai"
                                                            name="semai" data-mask="00/00/0000" />
                                                        @error('semai')
                                                            <div
                                                                class="jquery-validation-error small form-text invalid-feedback">
                                                                {{ $message }}
                                                        ...
                                                        @enderror
                                                        <div class="input-group-append"
                                                            data-target="#datetimepicker-semai"
                                                            data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i
                                                                    class="fa fa-calendar"></i>
                                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="luas">Lahan Spoting {ha}</label>
                                                    <input type="number"
                                                        class="form-control @error('luas') is-invalid @enderror"
                                                        value="{{ old('luas', isset($edit) && $edit ? $lahan->luas : '0') }}"
